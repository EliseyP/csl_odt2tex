...
- **boldblack** - для случая ч/б печати, но когда серый цыет не подходит по каким-либо причинам. Тогда киноварь заменяется, как и в odt шаблоне на **bold black** начертание.    
