...
Для TeX-компиляции используются класс документа `churchslavichymnsbook.cls` и стилевой файл `churchslavichymn.sty`.  
...
При необходимости иметь две версии - **цветную** и **черно-белую,** можно работать только с цветной версией, а ч/б получать автоматически, для этого есть как **oobacis-макросы,** так и **py-скрипты** (будут выложены позже). 

Для шаблонов возможна работа LO-расширений:
- [https://github.com/EliseyP/oooInsertFW](https://github.com/EliseyP/oooInsertFW) - вставка т.н. **кустоды** - первое слово следующей страницы в правом нижнем углу страницы. Стиль врезки определен в шаблоне.  
- [https://github.com/EliseyP/Kinovar](https://github.com/EliseyP/Kinovar) - выделение текста киноварью. При конвертации и компиляции в TeX кустоды выставляются автоматичеки.  
